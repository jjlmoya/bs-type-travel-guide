<?php
/**
 * Plugin Name: Travel Guide Model [Post Type]
...
require_once plugin_dir_path(__FILE__) . '/TravelGuide.php';
function bs_travel_guide_get_post_type()
{
	return TravelGuide::getInstance('Guía de Viaje', 'Guías de viaje', "guia-de-viaje",
		array()
	);
}

function bs_travel_guide_register_post_type()
{
	$model = bs_travel_guide_get_post_type();
	$labels = array(
...
function bs_travel_guide_create_custom_params()
{
	$model = bs_travel_guide_get_post_type();
...
function bs_travel_guide_register($customType)
{
	$model = bs_travel_guide_get_post_type();
...
function bs_travel_guide_callback($fieldType)
{
	$model = bs_travel_guide_get_post_type();
	$customField = $model->customFields;
...
function bs_travel_guide_on_save($post_id)
{
